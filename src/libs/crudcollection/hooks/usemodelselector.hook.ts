...
export function useModelSelector(models:IModel[] = []) { 
  ...
  // const SelectModelArgs:React.ComponentProps<typeof InputSelect> = { 
  //   value: modelData.model.accessor, 
  //   SetValue: (selectedAccessor:string) => { 
  //     const model = models.find( model => model.accessor === selectedAccessor) 
  //       ?? defaultModelSelection.model; 
  //     SelectModel(model) 
  //   }, 
  //   options: models.map( model => { 
  //     return {label:model.label[0], value:model.accessor} 
  //   }) as IOption[], 
  //   multiple:false, 
  // } 
